...
export const Knowledge = (props) => {
  ...
  return (
    <div className=" grid grid-coloum ">
      <div className="w-[845px] h-[821px] border-2 mt-8">
        ...
        <div className=" mt-10 ml-4">
          ...
          <p className=" text-xl pt-5">#{tag1} <span className=" pl-4">#{tag2}</span></p>
          <p className=" text-[#6047EC] underline underline-offset-4 font-bold cursor-pointer text-xl pt-5">Mark as read</p>
        </div>
      </div>
      <div>bookmark</div>
    </div>
